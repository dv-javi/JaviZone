import AboutMeCard from "@/components/ui/cards/AboutMeCard/AboutMeCard";
    ...
    <>
      ...
      <main className="main-info">
        ...
        <AboutMeCard
          ...
          imageNames={["drumIcon", "video1", "video2", "video3"]}
          links={[
          ...
          logoHref="https://www.youtube.com/@Drm-Javi/videos"
        />
        ...
        <section className="biker-info">
          ...
          <img
            className="icon-bike"
            src={
              getAsset(images, assetPaths.aboutMeImage("bikeIcon", "svg"))
            }
          />
          <section className="bike-cards">
            <div className="lateral-bike-card bk1">
              <img
                ...
                src={
                  getAsset(images, assetPaths.aboutMeImage("bike1", "avif"))
                }
              />
            </div>
            <div className="center-bike-card bk2">
              <img
                className="bike-image-card"
                src={
                  getAsset(images, assetPaths.aboutMeImage("bike2", "avif"))
                }
              />
            </div>
            <div className="lateral-bike-card bk3">
              <img
                className="bike-image-card"
                src={
                  getAsset(images, assetPaths.aboutMeImage("bike3", "avif"))
                }
              />
            </div>
            <div className="center-bike-card bk4">
              <img
                className="bike-image-card"
                src={
                  getAsset(images, assetPaths.aboutMeImage("bike4", "avif"))
                }
              />
            </div>
          </section>
        ...
        <AboutMeCard
          ...
          imageNames={["gamerIcon", "gamer1", "gamer2", "gamer3"]}
          links={["", "", ""]}
          mediaTitles={["Dedsafio", "Anarchy", "Apocalypse Zombie"]}
          callToAction={
            <>
          ...
          logoHref="https://discord.gg/wfxxuzdHqd"
        />
      </main>
    </>
  );
